recipes.remove(<industrialforegoing:range_addon:6>, false);
recipes.remove(<industrialforegoing:range_addon:7>, false);
recipes.remove(<industrialforegoing:range_addon:8>, false);
